...
const SideNav = () => {
    ...
    return (
        access_token === null ? <Navigate to="/signin" /> :
            <>
                <section className='relative flex gap-10 py-0 m-0 max-md:flex-col' style={{ backgroundImage: `url('https://w0.peakpx.com/wallpaper/680/744/HD-wallpaper-colorful-background-ultra-aero-colorful-beautiful-yellow-spring-green-abstract-color-white-pink-design-light-background-colors-bright-colourful-shades-easter-vivid-pastel-soft-blur.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>

                    <div className="skicky top-[80px] z-30">

                        <div className='relative md:hidden bg-white py-1 border-b border-grey flex flex-nowrap overflow-x-auto ' style={{ backgroundImage: `url('https://w0.peakpx.com/wallpaper/680/744/HD-wallpaper-colorful-background-ultra-aero-colorful-beautiful-yellow-spring-green-abstract-color-white-pink-design-light-background-colors-bright-colourful-shades-easter-vivid-pastel-soft-blur.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
