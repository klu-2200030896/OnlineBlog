    ...
    return (
        access_token ?
            ...
            <AnimationWrapper keyValue={type}>
                <section className="h-cover flex items-center justify-center" style={{ backgroundImage: `url('https://www.freevector.com/uploads/vector/preview/31147/Freevector_Colorful-Abstract-Background_mf0221.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <Toaster />
